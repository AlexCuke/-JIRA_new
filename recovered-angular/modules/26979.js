// Extracted from main; webpack module 26979. Factory, not an ES module.
((Ae, V, i) => {
  "use strict";
  ...
  let N = (() => {
      ...
      return O.ɵfac = function (C) {
        ...
        type: O,
        selectors: [["lu-calendar-period-to"]],
        ...
        styles: ["[_nghost-%COMP%]{--lu-floated-border: var(--lu-calendar-period-to-border)}"],
        changeDetection: 0
      }), O;
    })(),
    I = (() => {
