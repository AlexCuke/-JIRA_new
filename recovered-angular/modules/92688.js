// Extracted from main; webpack module 92688. Factory, not an ES module.
((Ae, V, i) => {
  "use strict";
  ...
  var t = i(94650),
    ...
    T = i(36895);
  function R(Le, ke) {
    if (1 & Le && t._UZ(0, "lu-calendar", 10), 2 & Le) {
      const J = t.oxw(),
        fe = t.MAs(1);
      t.Q6J("selectionState", fe.selectionState)("multiselect", !0)("dayClass", J.dayClass)("dayIsDisabled", J.dayIsDisabled)("minDate", J.getMinDate())("maxDate", J.getMaxDate())("periodMin", J.periodMin)("periodMax", J.periodMax);
    }
  }
  const B = [[["", "luCalendarPeriodFieldsDelimiter", ""]]],
    y = ["[luCalendarPeriodFieldsDelimiter]"];
  let j = (() => {
      class Le {}
      return Le.ɵfac = function (J) {
        return new (J || Le)();
      }, Le.ɵdir = t.lG2({
        type: Le,
        selectors: [["", "luCalendarPeriodFieldsDelimiter", ""]]
      }), Le;
    })(),
    W = (() => {
      class Le extends h.zH {
        get disabled() {
        ...
        constructor(J, fe, ye) {
          super(J, void 0, ye), this.changeDetectorRef = J, this.dateAdapter = fe, this.ngControl = ye, this.size = "small", this._disabled = !1, this.calendarIcon = !0, this.inputId = null, this.dayIsDisabled = () => !1, this.dayClass = () => "", this.placeholder = null, this.dataTestRole = "calendarPeriod", this.minDate = this.dateAdapter.addYears(this.dateAdapter.startOfDay(this.dateAdapter.today()), -100), this.maxDate = this.dateAdapter.addYears(this.dateAdapter.startOfDay(this.dateAdapter.today()), 100);
        }
        getCheckedMinDate(J) {
          return J ?? this.minDate;
        }
        getCheckedMaxDate(J) {
          return J ?? this.maxDate;
        }
        getMinDate() {
          return this.getCheckedMinDate("start-editing" === this.periodHost?.selectionState ? this.startMinDate : this.endMinDate);
        }
        getMaxDate() {
          return this.getCheckedMaxDate("start-editing" === this.periodHost?.selectionState ? this.startMaxDate : this.endMaxDate);
        }
        getDisplayFormatFromSize() {
          switch (this.size) {
            case "small":
            default:
              return this.dateAdapter.formats().display.inputFormat;
            case "medium":
              return this.dateAdapter.formats().display.medium;
          }
        }
      }
      return Le.ɵfac = function (J) {
        return new (J || Le)(t.Y36(t.sBO), t.Y36(A.SW), t.Y36(e.a5, 10));
      }, Le.ɵcmp = t.Xpm({
        type: Le,
    ...
    F = (() => {
      ...
      return Le.ɵfac = function (J) {
        ...
        imports: [T.ez, N.LA, I.f, a.b, m.CT, O.J, L.Ki, C.$, f.N, d.C, M.i, b.c, v.Y, E.B]
      }), Le;
    })();
});
