// Extracted from main; webpack module 32619. Factory, not an ES module.
((Ae, V, i) => {
  "use strict";
  ...
  var t = i(94650),
    ...
    d = i(12168),
    M = i(36895);
  const b = [[["lu-svg-icon"]], "*", [["", "luRadioDescription", ""]]],
    A = ["lu-svg-icon", "*", "[luRadioDescription]"];
  let I = (() => {
      class L extends m.DA {
        constructor(v, f, E, h, x) {
          super(v, f, h, E), this.changeDetectorRef = v, this.compareHost = f, this.ngControl = E, this.controlHost = h, this.elementRef = x, this.color = "default", this.ignoreTextClick = !1, this.isDashed = !1, this.inputId = null, this.elementRef?.nativeElement?.setAttribute("data-test-role", "clickableElement");
        }
        onTextClick(v) {
          this.ignoreTextClick && v.preventDefault();
        }
      }
      return L.ɵfac = function (v) {
        return new (v || L)(t.Y36(t.sBO), t.Y36(m.Vg, 8), t.Y36(e.a5, 10), t.Y36(a.fU, 8), t.Y36(t.SBq));
      }, L.ɵcmp = t.Xpm({
        type: L,
        selectors: [["lu-radio"]],
        hostVars: 2,
