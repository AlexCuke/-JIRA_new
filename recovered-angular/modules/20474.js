// Extracted from main; webpack module 20474. Factory, not an ES module.
(function (Ae, V, i) {
  (function () {
    var t,
      m = {}.hasOwnProperty;
    t = i(58563), Ae.exports = function (d) {
      function M(b, A) {
        if (M.__super__.constructor.call(this, b), null == A) throw new Error("Missing element text");
      ...
      return function (d, M) {
        ...
        return this.options.writer.set(b).text(this);
      }, M;
    }(t);
  }).call(this);
});
