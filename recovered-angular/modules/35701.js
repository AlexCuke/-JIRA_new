// Extracted from main; webpack module 35701. Factory, not an ES module.
((Ae, V, i) => {
  "use strict";
  ...
  var t = function () {
    ...
    N = function (I) {
      function O(L, C) {
        ...
        }(this, (O.__proto__ || Object.getPrototypeOf(O)).call(this, m.C_START_CHAR + L, C));
      }
      return function A(I, O) {
        ...
        key: "valid",
        value: function () {
          return new RegExp("^" + m.C_CHARS + "+$").test(this.data);
        }
      }]), O;
    }(a.default);
  V.default = N;
