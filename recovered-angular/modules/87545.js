// Extracted from main; webpack module 87545. Factory, not an ES module.
((Ae, V, i) => {
  "use strict";
  ...
  var t = i(94650),
    ...
    N = i(82265);
  function I(x, u) {
    1 & x && t._UZ(0, "lu-svg-icon", 10);
  }
  function O(x, u) {
    1 & x && t._UZ(0, "lu-svg-icon", 11);
  }
  function L(x, u) {
    1 & x && (t.TgZ(0, "div", 12), t.Hsn(1, 2), t.qZA());
  }
  const C = [[["lu-svg-icon"]], "*", [["", "luCheckboxDescription", ""]]],
    v = ["lu-svg-icon", "*", "[luCheckboxDescription]"];
  let f = (() => {
      class x {}
      return x.ɵfac = function (T) {
        ...
        type: x,
        selectors: [["", "luCheckboxDescription", ""]]
      }), x;
    })(),
    E = (() => {
      class x extends d.DA {
        get checked() {
          return super.checked;
        }
        set checked(T) {
          T && "false" !== T ? this.select() : this.deselect();
        }
        constructor(T, R, B, y, j, W) {
          super(T, B, j, y, !0), this.changeDetectorRef = T, this.ngZone = R, this.compareHost = B, this.ngControl = y, this.controlHost = j, this.elementRef = W, this.inputId = null, this.color = "default", this.ignoreTextClick = !1, this.elementRef?.nativeElement?.setAttribute("data-test-role", "clickableElement");
        }
        onTextClick(T) {
          this.ignoreTextClick && T.preventDefault();
        }
      }
      return x.ɵfac = function (T) {
        return new (T || x)(t.Y36(t.sBO), t.Y36(t.R0b), t.Y36(d.Vg, 8), t.Y36(e.a5, 10), t.Y36(m.fU, 8), t.Y36(t.SBq));
      }, x.ɵcmp = t.Xpm({
        type: x,
