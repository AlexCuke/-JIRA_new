// Extracted from main; webpack module 80668. Factory, not an ES module.
((Ae, V, i) => {
  "use strict";
  ...
  var t = i(94650),
    ...
    m = i(70823);
  function d(C, v) {
    1 & C && (t.TgZ(0, "div", 5), t.Hsn(1, 1), t.qZA());
  }
  function M(C, v) {
    1 & C && (t.TgZ(0, "div", 6), t.Hsn(1, 2), t.qZA());
  }
  const b = ["*", [["lu-svg-icon"]], [["", "luReplacementMessageTitle", ""]]],
    A = function (C) {
      return {
        type: C
      };
    },
    N = ["*", "lu-svg-icon", "[luReplacementMessageTitle]"];
  let I = (() => {
      class C {}
      return C.ɵfac = function (f) {
        ...
        type: C,
        selectors: [["", "luReplacementMessageTitle", ""]]
      }), C;
    })(),
    O = (() => {
      class C {
        constructor() {
          this.type = "success", this.orientation = "horizontal", this.size = "small", this.absolute = !1;
        }
      }
      return C.ɵfac = function (f) {
        return new (f || C)();
