// Extracted from main; webpack module 82409. Factory, not an ES module.
((Ae, V, i) => {
  "use strict";
  ...
  var t = i(94650),
    ...
    E = i(36895);
  function h(T, R) {
    if (1 & T && t._UZ(0, "lu-calendar", 8), 2 & T) {
      const B = t.oxw();
      t.Q6J("minDate", B.minDate)("maxDate", B.maxDate)("dayIsDisabled", B.dayIsDisabled)("dayClass", B.dayClass);
    }
  }
  let x = (() => {
      class T extends O.R {
        constructor() {
          super(...arguments), this.inputId = null, this.size = "extra-large", this.calendarIcon = !0;
        }
        ngAfterViewInit() {
          this.hasValue || (this.updateModel(this.dateAdapter.today()), this.changeDetectorRef.detectChanges());
        }
        preventOpen(B) {
          B.preventDefault();
        }
        formatData(B) {
          return "0" === B[0] ? B.replace("0", "") : B;
        }
      }
      return T.ɵfac = function () {
        let R;
        return function (y) {
          return (R || (R = t.n5z(T)))(y || T);
        };
      }(), T.ɵcmp = t.Xpm({
        type: T,
    ...
    u = (() => {
      ...
      return T.ɵfac = function (B) {
        ...
        imports: [E.ez, L.o, e.LA, a.f, m.Ki, b.N, d.$, M.J, C.CT, v.$, f.Y, A.B]
      }), T;
    })();
});
