// Extracted from main; webpack module 84519. Factory, not an ES module.
(function (Ae, V, i) {
  !function (t) {
    "use strict";
    ...
    var e = {
      ...
      d = function (A) {
        return function (N, I, O, L) {
          var C = a(N),
            v = m[A][a(N)];
          return 2 === C && (v = v[I ? 0 : 1]), v.replace(/%d/i, N);
        };
      },
    ...
    t.defineLocale("ar-ly", {
      ...
      postformat: function (A) {
        return A.replace(/\d/g, function (N) {
          return e[N];
        }).replace(/,/g, "،");
      },
      week: {
