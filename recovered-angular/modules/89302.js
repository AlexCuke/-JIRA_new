// Extracted from main; webpack module 89302. Factory, not an ES module.
((Ae, V, i) => {
  "use strict";
  ...
  a.ɵfac = function (M) {
    ...
    styles: ["[_nghost-%COMP%]{display:flex;color:#b3b3b3}[_nghost-%COMP%]:hover{color:#999}  .iconClass{border-radius:40px}"]
  });
});
