// Extracted from main; webpack module 52470. Factory, not an ES module.
((Ae, V, i) => {
  "use strict";
  ...
  var t = i(97582),
    ...
    A = i(36895),
    N = i(93278);
  const I = [[["label"]], "*", [["lu-form-message"]]];
  var L;
  let C = L = class {
    constructor(E, h) {
      this.changeDetectorRef = E, this.elementRef = h, this.orientation = "vertical", this.messageOrientation = "vertical", this.labelAlign = "left", this.state = "default", this.stateChanges = new m.x();
    }
    ngAfterContentInit() {
      this.messages?.changes.pipe((0, a.O)(this.messages.toArray()), (0, d.t)(this)).subscribe(E => {
        const h = E.some(u => "error" === u.type),
          x = E.some(u => "warning" === u.type);
        this.state = h ? "error" : x ? "warning" : "default", this.stateChanges.next(this.state), this.changeDetectorRef.detectChanges();
      }), this.elementRef?.nativeElement?.querySelector("label")?.setAttribute("data-test-role", "title"), this.elementRef?.nativeElement?.setAttribute("data-test-role", "field");
    }
  };
  C.ɵfac = function (E) {
    return new (E || C)(e.Y36(e.sBO), e.Y36(e.SBq));
  }, C.ɵcmp = e.Xpm({
    type: C,
