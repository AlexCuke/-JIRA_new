( () => {
    ...
    r.O = (n, t, i, d) => {
        if (!t) {
            ...
            for (f = 0; f < e.length; f++) {
                for (var [t,i,d] = e[f], l = !0, o = 0; o < t.length; o++)
                    (!1 & d || a >= d) && Object.keys(r.O).every(p => r.O[p](t[o])) ? t.splice(o--, 1) : (l = !1,
                    d < a && (a = d));
                if (l) {
                    e.splice(f--, 1);
                    var c = i();
    ...
    ( () => {
        ...
        var n = (i, d) => {
            ...
            for (i && i(d); u < f.length; u++)
                r.o(e, c = f[u]) && e[c] && e[c][0](),
                e[c] = 0;
            return r.O(s)
        }
